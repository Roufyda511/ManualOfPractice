...
$(function () {
    ...
    ZoomMtg.preLoadWasm();
    console.log('prepareJssdk');
    ZoomMtg.prepareJssdk();
    console.log(JSON.stringify(ZoomMtg.prepareJssdk()));
    ...
    document.getElementById('join_meeting').addEventListener('click', function(e){
        ...
        var meetConfig = {
            apiKey: "EvraXcdaSw2d2UsTvUR3QQ",
            apiSecret: "XzMvyjYwE0rC8EpixpseQNkZjfz1uo8gAtnb",
                ...
                ZoomMtg.join(
                    {
                        ...
                        userEmail:'Roufydadalal511@gmail.com',
                        success: function(res){
                            $('#nav-tool').hide();
